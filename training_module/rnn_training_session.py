...
def rnn_training_setup(transformation, input_size, input_feature_name):
    model_classes = [
        RNN,
        LSTM,
        BiLSTM,
...
if __name__ == "__main__":
    ...
    rnn_training_setup(get_mel_transformation(), config.N_MELS, "Mel-Spectrogram")
    rnn_training_setup(get_mfcc_transformation(), config.N_MFCC, "MFCC")